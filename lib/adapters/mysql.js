...
const CONFIG = {
  ...
  port: _.defaultTo(process.env.MYSQL_PORT, 8889),
  user: _.defaultTo(process.env.MYSQL_USER, 'root'),
  password: _.defaultTo(process.env.MYSQL_PASSWORD, 'root'),
  database: _.defaultTo(process.env.MYSQL_DB, 'adelia_test')
}
